...
public class Suivi1PostServices {
    ...
    public ResponseEntity<Consultations1Post_Immediat> registerSuivi1Post_Immediat(Consultations1Post_Immediat p1) throws Exception {
        Consultations1Post_Immediat suivi1Post_immediat = new Consultations1Post_Immediat(
                ...
                cryptDecrypt.encryptSensitiveInformation(p1.getDate_suivi()),
                ...
                cryptDecrypt.encryptListeSensitiveInformation(p1.getArthrodese_etage()),
                ...
                cryptDecrypt.encryptSensitiveInformation(p1.getLombalgie()),
                cryptDecrypt.encryptSensitiveInformation(p1.getSciatique()),
                cryptDecrypt.encryptSensitiveInformation(p1.getCruralgie()),
                cryptDecrypt.encryptListeSensitiveInformation(p1.getTrouble_vesico_sphincteriens()),
                cryptDecrypt.encryptSensitiveInformation(p1.getTrouble_vesico_sphincteriens_Incontinence_urinaire()),
                ...
                cryptDecrypt.encryptSensitiveInformation(p1.getSensibilte_musculaire_l2()),
                cryptDecrypt.encryptSensitiveInformation(p1.getSensibilte_musculaire_l3()),
                cryptDecrypt.encryptSensitiveInformation(p1.getSensibilte_musculaire_l4()),
                cryptDecrypt.encryptSensitiveInformation(p1.getSensibilte_musculaire_l5()),
                cryptDecrypt.encryptSensitiveInformation(p1.getSensibilte_musculaire_s1()),
