...
public class FichePatientService {
    ...
    public ResponseEntity<FichePatient> registerPatient(FichePatient p1) throws Exception {
     ...
     //   p1.setAdministrateur(administrateur);
        ...
        FichePatient savedPatient = new FichePatient(
        ...
        if (savedPatient != null) {
            FichePatient fichePatient = fichePatientRepository.save(savedPatient);
            return new ResponseEntity<FichePatient>(fichePatient, HttpStatus.OK);
        } else {
